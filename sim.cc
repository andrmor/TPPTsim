...
//        SM.SourceMode       = new FromFileSource("/home/andr/WORK/TPPT/Pes-Gel-E4-1e7.dat", false);
        ...
        SM.SimMode          = new PesGenerationMode(1000,  {1.0, 1.0, 1.0}, {91, 200, 91}, {-45.5, -150, -45.5},  {{417,2217}}); // Direct PES mode; number of protons = events times last argument in PencilBeam!
