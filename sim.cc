...
int main(int argc, char** argv)
{
    ...
    else
    {
     // --- START of user init ---
        ...
        SM.PhantomMode      = new PhantomDICOM("/home/andr/WORK/TPPT/DicomPhant", "headCT_", 84, 252, 64, 155.0, {0,0,0});
        ...
        */
        ...
        //SM.SimMode          = new ActivityProfilerMode({{0,194,1}}, {{417,418}}, "/home/andr/WORK/TPPT/TMP", "ap1");
