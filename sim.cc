...
// --- START of user init ---
  ...
  // Detector
    ...
    //SM.DetectorComposition = {DetComp::Scintillators, DetComp::SIPM, DetComp::PCB, DetComp::Base};
    //SM.DetectorComposition = {DetComp::Scintillators, DetComp::Base, DetComp::SIPM, DetComp::PCB, DetComp::CopperStructure};
