...
int main(int argc, char** argv)
{
    ...
    else
    {
     // --- START of user init ---
        ...
        SM.PhantomMode      = new PhantomDICOM("/home/andr/WORK/TPPT/DicomPhant", "headCT_", 84, 252, 1, 155.0, {0,0,0});
//        SM.PhantomMode      = new PhantomDICOM("/home/andr/WORK/TPPT/DicomPhant", "headCT_", 125, 210, 1, 155.0, {0,0,0});
//        SM.PhantomMode      = new PhantomDICOM("/home/andr/WORK/TPPT/DicomPhant", "headCT_", 125, 127, 4, 155.0, {0,0,0});
        ...
        */
        ...
        //SM.SourceMode       = new PencilBeam(new Geantino, new ConstantTime(0), {0, 200, 0.1}, {0,-1.0,0});
